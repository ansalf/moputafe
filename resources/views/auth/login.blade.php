                ...
                <form action="{{ route('authenticate') }}" method="POST" class="p-4 p-md-5 border rounded-3 bg-light"
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="username" name="username"
                            style="border-radius: 10px;" placeholder="Username">
                    ...
                    <button class="w-100 btn btn-lg btn-secondary" type="submit" style="border-radius: 30px;"><a
                            href="/dashboard" style="color: white; text-decoration:none;">Login</button>
                    <hr class="my-4">
